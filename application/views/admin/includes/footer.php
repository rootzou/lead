        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="copyright">
              ...
              <a href="https://webmedia-tunisie.com/">WebMedia</a>
            </div>
            <div>
              Distributed by
              <a target="_blank" href="https://webmedia-tunisie.com/">WebMedia</a>.
            </div>
          </div>
        </footer>
      </div>
    ...
    <script src="<?=base_url('assets_admin/js/setting-demo.js')?>"></script>
