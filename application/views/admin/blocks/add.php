<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Ajouter un Bloc</h4>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Nouveau Bloc</div>
                    </div>
                    <div class="card-body">
                        <?php echo form_open('admin/blocks/add', ['class' => 'form-horizontal']); ?>
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="orderB" name="orderB" 
                                            value="<?php echo set_value('orderB', 0); ?>" required>
